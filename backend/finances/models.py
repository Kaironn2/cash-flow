...
class InstallmentExpense(models.Model):
    ...
    category = models.ForeignKey(Category, on_delete=models.CASCADE, related_name='installments')
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
...
class Expense(models.Model):
    ...
    category = models.ForeignKey(
        Category, on_delete=models.SET_NULL, related_name='expenses',
        blank=True, null=True,
    )
    paid = models.BooleanField(default=False)
    installment_origin = models.ForeignKey(
        InstallmentExpense, on_delete=models.CASCADE, related_name='expenses',
        blank=True, null=True,
    )
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
